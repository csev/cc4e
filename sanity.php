...
/**
 * Installation sanity checks for the CC4E home page only.
 */

function cc4e_sanity_die($title, $body_html) {
    error_log('CC4E sanity: '.$title);
...
if ( ! is_dir($tsugi_dir) ) {
    cc4e_sanity_die(
        ...
        '<p>This copy of C Programming for Everybody expects a <code>tsugi</code> folder next to
        <code>index.php</code>, but that folder was not found.</p>
        <p>From your <code>cc4e</code> directory, check out Tsugi:</p>
        <pre>cd cc4e
git clone https://github.com/tsugiproject/tsugi.git tsugi</pre>
        ...
        <p>More detail: <a href="https://github.com/csev/cc4e"
        target="_blank" rel="noopener noreferrer">CC4E on GitHub</a></p>'
    );
}
...
if ( count($missing) > 0 ) {
    cc4e_sanity_die(
        ...
        <p>From your <code>cc4e</code> directory, refresh the Tsugi checkout:</p>
        <pre>cd cc4e/tsugi
git pull
